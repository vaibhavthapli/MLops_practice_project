...
class DataTransformationConfig:
    preprocessed_data = os.path.join("artifacts","preprocessed.pkl")
    ...
    def initiate_data_transormation(self, train_path, test_path):
        try:
            ...
            save_object(
                ...
                file_path=self.data_transformation_config.preprocessed_data,
            ...
            return (
                ...
                train_arr,
                test_arr,
                self.data_transformation_config.preprocessed_data
            )
